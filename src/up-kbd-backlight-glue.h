...
#ifndef __dbus_glib_marshal_up_kbd_backlight_MARSHAL_H__
#define __dbus_glib_marshal_up_kbd_backlight_MARSHAL_H__
...
void
dbus_glib_marshal_up_kbd_backlight_BOOLEAN__POINTER_POINTER (GClosure     *closure,
...
static const DBusGMethodInfo dbus_glib_up_kbd_backlight_methods[] = {
  { (GCallback) up_kbd_backlight_get_max_brightness, dbus_glib_marshal_up_kbd_backlight_BOOLEAN__POINTER_POINTER, 0 },
  { (GCallback) up_kbd_backlight_get_brightness, dbus_glib_marshal_up_kbd_backlight_BOOLEAN__POINTER_POINTER, 70 },
...
"org.freedesktop.UPower.KbdBacklight\0BrightnessChanged\0\0",
"\0"
};
