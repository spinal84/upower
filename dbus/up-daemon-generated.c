...
static const _ExtendedGDBusArgInfo * const _up_exported_daemon_method_info_enumerate_devices_OUT_ARG_pointers[] =
{
  &_up_exported_daemon_method_info_enumerate_devices_OUT_ARG_devices,
  NULL
};
...
static const _ExtendedGDBusArgInfo * const _up_exported_daemon_method_info_get_display_device_OUT_ARG_pointers[] =
{
  &_up_exported_daemon_method_info_get_display_device_OUT_ARG_device,
  NULL
};
...
static const _ExtendedGDBusArgInfo * const _up_exported_daemon_method_info_get_critical_action_OUT_ARG_pointers[] =
{
  &_up_exported_daemon_method_info_get_critical_action_OUT_ARG_action,
  NULL
};
...
static const _ExtendedGDBusMethodInfo * const _up_exported_daemon_method_info_pointers[] =
{
  &_up_exported_daemon_method_info_enumerate_devices,
  &_up_exported_daemon_method_info_get_display_device,
...
static const _ExtendedGDBusArgInfo * const _up_exported_daemon_signal_info_device_added_ARG_pointers[] =
{
  &_up_exported_daemon_signal_info_device_added_ARG_device,
  NULL
};
...
static const _ExtendedGDBusArgInfo * const _up_exported_daemon_signal_info_device_removed_ARG_pointers[] =
{
  &_up_exported_daemon_signal_info_device_removed_ARG_device,
  NULL
};
...
static const _ExtendedGDBusSignalInfo * const _up_exported_daemon_signal_info_pointers[] =
{
  &_up_exported_daemon_signal_info_device_added,
  &_up_exported_daemon_signal_info_device_removed,
  NULL
};
...
static const _ExtendedGDBusPropertyInfo * const _up_exported_daemon_property_info_pointers[] =
{
  &_up_exported_daemon_property_info_daemon_version,
  &_up_exported_daemon_property_info_on_battery,
  &_up_exported_daemon_property_info_lid_is_closed,
  &_up_exported_daemon_property_info_lid_is_present,
  NULL
};
  ...
  GParamSpec   *pspec G_GNUC_UNUSED)
{
  ...
  info = _up_exported_daemon_property_info_pointers[prop_id - 1];
  ...
  if (!_g_value_equal (value, &skeleton->priv->properties[prop_id - 1]))
    {
      if (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)) != NULL)
        _up_exported_daemon_schedule_emit_changed (skeleton, _up_exported_daemon_property_info_pointers[prop_id - 1], prop_id, &skeleton->priv->properties[prop_id - 1]);
